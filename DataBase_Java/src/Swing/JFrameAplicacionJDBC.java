...
import LogicaClases.TarjetaCreditoDAO;
 ...
 * @author UsuarioPero
 */
public class JFrameAplicacionJDBC extends javax.swing.JFrame {

    ModeloTablaTarjetaCredito modelo;
    TarjetaCreditoDAO dao;

    public JFrameAplicacionJDBC() {
        initComponents();
    ...
    private void jMenuItemCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCrearActionPerformed
        ...
        if (jDialog.getTarjeta() != null) {
            if (modelo.añadirTarjetaCredito(jDialog.getTarjeta())) {
                ...
                dao.insertarTarjetaCredito(jDialog.getTarjeta());
    ...
    private void jMenuItemEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemEliminarActionPerformed
        ...
        if (this.modelo.existeIndice(fila)) {
            ...
            if (modelo.eliminarTarjetaCredito(fila)) {
                modelo.fireTableDataChanged();
                dao.eliminarTarjetaCredito(tarjeta.getNumeroTarjeta());
            ...
            if (pinNuevo != null) {
                if (Funciones.Funciones.ValidarNumeroPin(pinNuevo)) {
                    if (modelo.setPin(fila, pinNuevo)) {
                        modelo.fireTableDataChanged();
                        TarjetaCredito tarjeta = this.modelo.getTarjeta(fila);
                        dao.modificarCodigoPin(tarjeta.getNumeroTarjeta(), pinNuevo);
        ...
        if (this.modelo.existeIndice(fila)) {
            ...
            if (concepto != null && cantidad != 0) {
                if (modelo.realizarPago(fila, cantidad, concepto)) {
                    modelo.fireTableDataChanged();
                    dao.introducirMovimientos(this.modelo.getTarjeta(fila));
    ...
    private void jMenuItemCargarTarjetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCargarTarjetaActionPerformed
        ...
        if (comprobanteSeleccionFichero == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Logger.getLogger(JFrameAplicacionJDBC.class
                        .getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(JFrameAplicacionJDBC.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameAplicacionJDBC.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameAplicacionJDBC().setVisible(true);
            }
        });
    }
