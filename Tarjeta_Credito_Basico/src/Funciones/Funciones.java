...
public class Funciones {
     ...
     *
     * @param numero numero introducido por el usuario
     ...
     */
    public static boolean ValidarLimite(int numero, int maximo, int minimo) {
     ...
     */
    public static void GeneradorCVV(int[] CVV) {
    ...
    public static boolean validarNumerosDeLaTarjeta(String numero) {
        Pattern patron = Pattern.compile("\"^\\\\d{16}$");
     ...
     */
    public static TarjetaCredito crearTarjetaCredito(TarjetaCredito[] array) {
        ...
        } while (!ValidarDocumentoIdentidad(nif) && !buscarNIF(nif, array));
        do {
        ...
        array[tarjetasCreditoCreadas] = new TarjetaCredito(titular, nif, pin, limite, numeroTarjeta);
     ...
     * @param array el array creado en el main
     */
    public static void eliminarTarjetaCredito(String NIF, TarjetaCredito[] array) {
        if (buscarNIF(NIF, array)) {
            ...
            Funciones.compactarTarjetaCredito(array);
        } else {
            System.out.println("El NIF introducido no aparece, por lo tanto no se elimino nada");
        }
    }

    public static void compactarTarjetaCredito(TarjetaCredito[] array) {
     ...
     *
     * @param indice es la posicion donde esta la tarjeta
     * @param array lista donde se acumulan
     */
    public static void borradoDeTarjeta(int indice, TarjetaCredito[] array) {
     ...
     * @param array array del main que almancena la tarjeta de credio
     * @return busqueda
     */
    public static boolean buscarNIF(String nif, TarjetaCredito[] array) {
        boolean busqueda = false;
        nif = nif.toUpperCase();
        for (int i = 0; i < tarjetasCreditoCreadas; i++) {
     ...
     * creada
     * @param array array creado en el main
     */
    public static void gestionTarjetaCredito(int indiceSubMenu, String nif, TarjetaCredito[] array) {
        Scanner teclado = new Scanner(System.in);
        final int MOSTRAR_NUMERO_TARJETA = 1;
        final int MOSTRAR_TITULAR=2;
        final int MOSTRAR_AÑO_CADUCIDAD=3;
        final int MODIFICAR_PIN = 4;
        final int REALIZAR_PAGO=5;
        final int CONSULTAR_MOVIMIENTOS=6;
        final int TOTAL_GASTADO_TARJETA=7;
        if (Funciones.buscarNIF(nif, array)) {
            TarjetaCredito tarjeta = array[indiceArrayBusquedaNIF];
            Funciones.mostrarSubMenu();
            switch (indiceSubMenu) {
                case MOSTRAR_NUMERO_TARJETA ->
                    System.out.print(tarjeta.getNumeroTarjeta());
                case MOSTRAR_TITULAR ->
                    System.out.print(tarjeta.getTitular());
                case MOSTRAR_AÑO_CADUCIDAD ->
     ...
     * @return gastoTotal
     */
    public static double mostrarGastoTotalTarjetas(TarjetaCredito[] array) {
        double gastoTotal = 0;
        for (int i = 0; i < tarjetasCreditoCreadas; i++) {
