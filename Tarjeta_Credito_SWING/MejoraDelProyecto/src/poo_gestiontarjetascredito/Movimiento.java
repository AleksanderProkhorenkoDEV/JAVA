...
public class Movimiento implements Serializable {
    ...
    /**
     * Es el construcor de Movimiento, con sus respectivas validaciones para no construir un objeto erroneo
    ...
    /**
     * Es el metodo getter con el cual devuelve el dinero introducido por el usuario
    ...
    /**
     * Es un metodo getter con el cual devuelve la cadena de texto introducida por el user
    ...
    /**
     * Metodo setter sobre el concepto introducido por el user, mediante una validacion de una funcion externa 
    ...
    /**
     * Metodo equals() compara dos movimientos mediante un if en el que compara todos los parametros del ulitmo movimiento con el nuevo
    ...
    /**
     * Metodo toString() con el cual el usuario puede visualizar los movimientos de una forma correcta
